...
class Agent:
    ...
    def run(self, client, user_prompt: str, model: str = "claude-3-7-sonnet-20250219"):
...
class TravelPlanner:
    ...
    def run_flight_agent(self, base_prompt: str) -> str:
        ...
        return self.flight_agent.run(self.client, flight_prompt)
    ...
    def run_hotel_agent(self, base_prompt: str, destination: str, budget: str) -> str:
        ...
        return self.hotel_agent.run(self.client, hotel_prompt)
    ...
    def run_attraction_agent(self, base_prompt: str, destination: str, interests: List[str]) -> str:
        ...
        return self.attraction_agent.run(self.client, attraction_prompt)
    ...
    def run_summary_agent(self, base_prompt: str, flight_result: str, hotel_result: str, attraction_result: str) -> str:
        ...
        {attraction_result}
        """
        return self.summary_agent.run(self.client, summary_prompt)
